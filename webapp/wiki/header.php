...
<header class="site-header">
  <div class="container-lg py-0">
    <div class="d-flex align-items-center gap-3" style="height:56px">
      <a class="logo" href="/works/webapp/home.php">Portal <span class="logo-wiki">Wiki</span></a>
      ...
      <?php if ($isLoggedIn): ?>
      <a href="/works/webapp/wiki/profile.php?user=<?php echo urlencode($clientName); ?>" class="hbtn icon" style="text-decoration:none" title="My Profile">
